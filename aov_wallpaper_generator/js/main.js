...
const custom_utils = ['aov-logo-1','aov-logo-2','aov-logo-3','aov-logo-4','aov-logo-5','fire-splash','splash-blue','tencent-1'];
...
$(function(){
  $('#aov-canvas-wrapper').css({"width": canvas_width, "height": canvas_height, "margin": is_tablet_or_mobile ? 'auto': 'initial'});
	//render bg thumbs
...
function render_custom_utils(container){
  ...
  $.each(custom_utils, function(i,data){
    html = html + '<img src="images/thumbs/'+data+'.jpg" data-source="images/'+data+'.png" data-sub="custom-utils" height="70" /> ';
    i++;
  });
...
var downloadCanvas =    function(name){
    var link = document.createElement("a");
      var imgData = stage.toDataURL({pixelRatio: canvas_ratio });
